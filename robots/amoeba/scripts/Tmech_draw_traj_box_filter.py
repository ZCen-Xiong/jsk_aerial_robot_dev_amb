...
def main(file_paths):
    ...
    colors_box = ['#E74C3C','#09D45A', "#0F66D0"]
    ...
    ax1.plot(x_ext_axis, rmse_vals_pos['x'], marker='o', label='X Error', color=colors_box[0])
    ax1.plot(y_ext_axis, rmse_vals_pos['y'], marker='o', label='Y Error', color=colors_box[1])
    ax1.plot(z_ext_axis, rmse_vals_pos['z'], marker='o', label='Z Error', color=colors_box[2])
    ...
    ax1.legend(fontsize=12, framealpha=legend_alpha)  # Set legend font size
    ...
    ax2.plot(x_ext_axis, [v * 180 / np.pi for v in rmse_vals_ang['roll']], marker='o', label='Roll Error', color=colors_box[0])
    ax2.plot(y_ext_axis, [v * 180 / np.pi for v in rmse_vals_ang['pitch']], marker='o', label='Pitch Error', color=colors_box[1])
    ax2.plot(z_ext_axis, [v * 180 / np.pi for v in rmse_vals_ang['yaw']], marker='o', label='Yaw Error', color=colors_box[2])
    ...
    ax2.legend(fontsize=12, framealpha=legend_alpha)  # Set legend font size
